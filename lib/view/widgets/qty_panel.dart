          ...
          children: [
            SizedBox(
              ...
              child: TextField(
                ...
                onSubmitted: (value) {
                  print(tabButtonIndexBloC.state.slideIndex);
                  sellPanelBloC.state.sellPanel[1].sellDataBloc.add(
                    SellDataAdd(
                        tableLine: TableLine(
                            document: "document",
                            goods: "goods",
                            qty: Qty(number: 1, uom: "uom"),
                            price: Price(
                                number: 1,
                                currency: "currency",
                                per: Qty(number: 1, uom: "uom")),
                            cost: Cost(number: 1, currency: "currency")),
                        data: data),
                  );
                },
                onChanged: (value) {
